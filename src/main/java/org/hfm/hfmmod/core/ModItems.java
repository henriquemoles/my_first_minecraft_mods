...
import org.hfm.hfmmod.items.CustomItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> CUSTOM_BLOCK = ITEMS.register("custom_block", () -> new BlockItem(ModBlocks.CUSTOM_BLOCK.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item>  CUSTOM_ITEM = ITEMS.register("custom_item", () -> new CustomItem(new Item.Properties()));
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("mod_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(MOD_BLOCK.get());
                output.accept(CUSTOM_BLOCK.get());
                output.accept(CUSTOM_ITEM.get());
